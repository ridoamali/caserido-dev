...
const DesignConfigurator = ({ configId, imageUrl, imageDimensions }: DesignConfiguratorProps) => {
  ...
  const { mutate: saveConfig, isPending } = useMutation({
    ...
    onError: () => {
      toast({
        title: "Error",
        description: "please try again karena error",
        variant: "destructive",
      });
    },
    onSuccess: () => {
  ...
  async function saveConfiguration() {
    try {
      ...
      toast({
        ...
        description: "There was something wrong with the server upload case",
        variant: "destructive",
      });
    }
  }
    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white">
        <ScrollArea className="relative flex-1 overflow-auto">
          <div aria-hidden="true" className="absolut z-10 inset-x-0 bottom-0 h-12 bg-gradient-to-t from-white pointer-events-none" />

          <div className="px-8 pb-12 pt-8 ">
            <h2 className="tracking-tight font-bold text-3xl">Kustomisasikan your case bro</h2>
            ...
            <div className="relative mt-4 h-full flex flex-col justify-between">
              ...
              <div className="flex flex-col gap-6">
                ...
                >
                  <Label>Warna: {options.color.label}</Label>
