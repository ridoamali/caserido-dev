...
const OrderReceivedEmail = ({ shippingAddress, orderId, orderDate }: { shippingAddress: ShippingAddress; orderId: string; orderDate: string }) => {
  const baseUrl = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://caserido-dev.vercel.app";
  // ubah url vercel atau server
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={paddingY}>
            ...
            <Row>
              <Text style={footer.text}>© CaseRido, Inc. All Rights Reserved.</Text>
            </Row>
          </Section>
        </Container>
      </Body>
